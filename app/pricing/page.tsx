        ...
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-white/10 bg-neutral-900 p-8">
            ...
            <Link
              ...
              className="block w-full text-center rounded-md bg-white text-black py-3 font-semibold hover:bg-white/90 transition"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="rounded-xl border border-purple-600 bg-neutral-900 p-8">
            ...
            <Link
              href="/auth/signup?next=/pricing"
              className="block w-full text-center rounded-md bg-purple-600 py-3 font-semibold hover:bg-purple-700 transition"
            >
              Get Started
            </Link>
          </div>
